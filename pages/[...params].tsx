            ...
            <section className="flex items-center h-screen p-16 dark:bg-gray-900 dark:text-gray-100">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                    <div className="max-w-md text-center">
                        ...
                        <p className="text-2xl font-semibold md:text-3xl">Sorry, we couldn&prime;t find this page.</p>
                        <p className="mt-4 mb-8 dark:text-gray-400">
                            But don&prime;t worry, you can find plenty of other things on our homepage.
                        </p>
                        <Link href="/">
